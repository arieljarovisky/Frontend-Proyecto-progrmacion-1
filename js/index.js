...
function showSection(sectionId) {
  ...
  let products = [
    ...
    { id: 3, name: "Producto 3", price: 15.50, image: "https://via.placeholder.com/150" },
    { id: 4, name: "Producto 4", price: 8.75, image: "https://via.placeholder.com/150" },
    { id: 5, name: "Producto 5", price: 12.30, image: "https://via.placeholder.com/150" },
    { id: 6, name: "Producto 6", price: 25.00, image: "https://via.placeholder.com/150" },
    { id: 7, name: "Producto 7", price: 18.20, image: "https://via.placeholder.com/150" },
    { id: 8, name: "Producto 8", price: 22.10, image: "https://via.placeholder.com/150" },
    { id: 9, name: "Producto 9", price: 9.99, image: "https://via.placeholder.com/150" },
    { id: 10, name: "Producto 10", price: 30.00, image: "https://via.placeholder.com/150" }
  ];
  ...
  function renderProducts() {
    ...
    products.forEach(product => {
      ...
      card.innerHTML = `
        ...
        <select id="quantity-${product.id}" class="border border-gray-300 rounded p-1 mt-2">
          ${[...Array(10).keys()].map(i => `<option value="${i + 1}">${i + 1}</option>`).join('')}
        </select>
        <button onclick="addToCart(${product.id})" class="mt-2 bg-green-500 hover:bg-green-600 text-white font-semibold py-1 px-3 rounded">
          Agregar al carrito
        </button>
      `;
  ...
  // Finaliza la venta: muestra el total, simula el pago y reinicia el carrito
  function finalizeSale() {
    ...
    alert(`Venta finalizada. Total a pagar: $${total.toFixed(2)}`);
    cart = [];
    renderCart();
  }
